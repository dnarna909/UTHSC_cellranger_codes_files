...
columns.select <- c("Counts_List", "sample_id_ori", "SQ_List" ,  "Sequencing_Date", "Lane" , 
                    ...
                    "Mean Reads per Cell" ,"Median Genes per Cell" , "Number of Reads", "Agg" , "Status",
                    "molecule_h5",  "Sample_Date",   "Cell Numbers",  "Library_ID", "Reads/Cell",
                    "Reads/Sample","Target %" , "Sum" , "I7_Index ID", "I7_Index_Sequence" ,
                    "I5_Index ID" , "I5_Index_Sequence")
df.depth <- df.all3[columns.select]
```
