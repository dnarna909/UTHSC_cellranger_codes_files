...
```{r}
cols2 = c("sample_id", "molecule_h5", "sample_id_ori2", "Counts_List")
Test <- df.all3[which(df.all3$Project == "STARR" & df.all3$sample_id_ori %in% c("STARR_085_Bar", 
                                                                                "STARR_085")), ]
...
Test <- df.all3[which(df.all3$Project == "STARR" & df.all3$sample_id_ori %in% c("STARR_077", "STARR_077_10",
