...
```{r}
Test <- df.all3[which(df.all3$Project == "STARR" & df.all3$sample_id_ori %in% c("STARR_077", "STARR_077_LS_force12248", "STARR_077_FZ_force12248")), ]
Test <- Test %>% arrange(sample_id)
write.csv(Test[cols], file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/STARR_FZ_Test.agg.csv", row.names=FALSE)
```
