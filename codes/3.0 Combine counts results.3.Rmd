...
saveRDS(SGLT2, file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/SGLT2.Final.rds")
```
...
STARR2 <- rbind(df.all3[which(df.all3$Project == "STARR" & df.all3$Agg == "Yes") , ][1:14, ], 
                df.all3[which((df.all3$sample_id %in% c("76664_V11")) & df.all3$Agg == "Yes") , ])
STARR2 <- STARR2 %>% arrange(sample_id)%>% mutate(Agg.List = 1:n() )
write.csv(STARR2[cols], file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/STARR.SGLT2.lowest.agg_15.csv", row.names=FALSE)
# xlsx::write.xlsx(STARR2, file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/2022-08-18 Prepare for UTSA/STARR.SGLT2.agg.xlsx", sheetName = "STARR", row.names=FALSE)
xlsx::write.xlsx(STARR2, file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/STARR.SGLT2.lowest_15.xlsx", sheetName = "STARR.SGLT2", row.names=FALSE)
saveRDS(STARR2, file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/STARR.SGLT2.lowest_15.rds")

STARR <- df.all3[which(df.all3$Project == "STARR" & df.all3$Agg == "Yes") , ]
STARR2 <- rbind(STARR[15:nrow(STARR), ], 
                df.all3[which((df.all3$sample_id %in% c("76664_V11")) & df.all3$Agg == "Yes") , ])
STARR2 <- STARR2 %>% arrange(sample_id)%>% mutate(Agg.List = 1:n() )
write.csv(STARR2[cols], file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/STARR.SGLT2.lowest.agg_15_n.csv", row.names=FALSE)
# xlsx::write.xlsx(STARR2, file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/2022-08-18 Prepare for UTSA/STARR.SGLT2.agg.xlsx", sheetName = "STARR", row.names=FALSE)
xlsx::write.xlsx(STARR2, file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/STARR.SGLT2.lowest_15_n.xlsx", sheetName = "STARR.SGLT2", row.names=FALSE)
saveRDS(STARR2, file = "/media/jianie/DATA/UTHSC_cellranger_codes_files/AggrFiles/STARR.SGLT2.lowest_15_n.rds")
