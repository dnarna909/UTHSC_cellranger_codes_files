...
sequencing.info <- aggr %>% dplyr::filter(Project == "STARR" &  Status == "Original" & 
...
select.sglt2 <- sglt2.samples.all %>% dplyr::filter(SingleNuclei == "Yes") %>% arrange(id) %>% pull(subject_id) %>% unique()
